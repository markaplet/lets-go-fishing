...
data merge block 10 13 -10 {Text1:'{"text":"Difficulty","clickEvent":{"action":"run_command","value":"function game:difficulty/hard"},"bold":true,"color":"gold"}',Text2:'{"text":""}',Text3:'{"text":"Easy","bold":true,"color":"green"}'}
