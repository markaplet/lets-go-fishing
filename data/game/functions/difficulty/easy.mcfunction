...
data merge block 10 13 -10 {Text1:'{"text":"","clickEvent":{"action":"run_command","value":"function game:difficulty/hard"}}',Text2:'{"text":"Difficulty","bold":true,"color":"gold"}',Text3:'{"text":"Easy","bold":true,"color":"green"}'}
